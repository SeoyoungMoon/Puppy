<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <section>
        ...
        <article class="main-container">
            <div class="wrap">
                <form action="<c:url value='/board/registForm'/>" name="registForm" method="post" class="boardWrite clearfix">
                    ...
                    <button type="button" id="res_btn" class="registBtn">등록</button>
                </form>
            </div>
        </article>
    </section>
    ...
    $('.listBtn').click(function() {
        if(confirm('목록으로 돌아가시겠습니까?')) {
           location.href='<c:url value="/board/boastboard" />';
        } else {
           return;
        }
     });
